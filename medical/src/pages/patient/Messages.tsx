        ...
        <div className="col-span-12 md:col-span-4 lg:col-span-3">
          <Card className="h-[calc(80vh-6rem)] flex flex-col">
            <div className="p-4 border-b border-white/10">
              <h2 className="text-lg font-medium text-white/90">Doctors</h2>
            </div>
              ...
              {loading ? (
                  ...
                  {contacts.map((contact) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-white/60">{contact.specialization || 'Doctor'}</p>
                ...
                <div className="flex flex-col items-center justify-center h-full p-4 text-center">
                  <p className="text-white/60 mb-4">
                    No contacts available. Once you schedule an appointment with a doctor, you'll be able to message them here.
                  </p>
                  <Button
                    variant="primary"
                    size="sm"
          ...
          <Card className="h-[calc(80vh-6rem)] flex flex-col">
            {selectedContact ? (
              <>
                ...
                <div className="p-4 border-b border-white/10 flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/60">{selectedContact.specialization || 'Doctor'}</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-center justify-center h-full p-6">
                <h3 className="text-xl font-medium text-white/90 mb-2">Select a contact</h3>
